...
static const std::map<uint32_t, tAssetDef> s_mOffsToFileName = {
	...
	{0x53AFF, tAssetDef {.AssetName = "tileset_world1", .isCompressed = {}, .onExtract = nullptr /*handleExtractTileset*/}},
	{0x58864, tAssetDef {.AssetName = "tiledef_world1", .isCompressed = {}, .onExtract = nullptr}},
	{0x5CDA7, tAssetDef {.AssetName = "tileset_world2", .isCompressed = {}, .onExtract = nullptr /*handleExtractTileset*/}},
	{0x62FB3, tAssetDef {.AssetName = "tiledef_world2", .isCompressed = {}, .onExtract = nullptr}},
	{0x6881E, tAssetDef {.AssetName = "tileset_world3", .isCompressed = {}, .onExtract = nullptr /*handleExtractTileset*/}},
	{0x6DDB2, tAssetDef {.AssetName = "tiledef_world3", .isCompressed = {}, .onExtract = nullptr}},
	{0x7480D, tAssetDef {.AssetName = "tileset_world4", .isCompressed = {}, .onExtract = nullptr /*handleExtractTileset*/}},
	{0x7A235, tAssetDef {.AssetName = "tiledef_world4", .isCompressed = {}, .onExtract = nullptr}},
	{0x7FD84, tAssetDef {.AssetName = "tileset_world5", .isCompressed = {}, .onExtract = nullptr /*handleExtractTileset*/}},
